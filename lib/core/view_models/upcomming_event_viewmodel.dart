...
class UpCommingEventViewModel extends ChangeNotifier {
  EventService eventService = locator<EventService>();

  viewState view_state = viewState.idle;
  EventModelList? upCommingeventModel;

  Future<EventModelList?> getUpCommingEventData() async {
    ...
    upCommingeventModel =
        await eventService.getUpcommingEvents(loggedInUserToken);
